...
const SliderButton: React.FC = () => {
  return (
    <div className="group relative flex items-center justify-between w-full  h-12 cursor-pointer">
      ...
      {/* Text */}
      <span className="relative z-10 pl-4 text-black font-semibold transition-opacity duration-500 group-hover:text-customOrange group-hover:animate-opacityNoneTo100 ">
        View More
      </span>
